...
public class SecurityConfig {
    ...
    ProfessionnelSanteDetailsService professionnelSanteDetailsService;
    ...
    @Bean
    public AuthenticationManager authenticationManagerProfessionnelSante() {
        DaoAuthenticationProvider daoAuthenticationProvider = new DaoAuthenticationProvider();
        daoAuthenticationProvider.setPasswordEncoder(passwordEncoder());
        daoAuthenticationProvider.setUserDetailsService(professionnelSanteDetailsService);
        return new ProviderManager(daoAuthenticationProvider);
    }
